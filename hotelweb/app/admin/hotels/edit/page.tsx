...
export default function EditHotelPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await api.put(`/api/hotels/${id}`, formData)// đơn giản
            ...
            const errorMessage = error.response?.data?.error || "Failed to update hotel. Please try again."
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight text-slate-900">Updating Hotel</h1>
                                <p className="text-slate-600">Update your hotel property in your system</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                        <CardHeader className="pb-6">
                            <CardTitle className="flex items-center space-x-2 text-xl">
                                ...
                                <span>Hotel Information Change</span>
                            </CardTitle>
